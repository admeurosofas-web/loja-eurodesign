...
export default function LeatherEditorial({ product }: LeatherEditorialProps) {
  return (
    <section id="couro" className="border-y border-linha bg-cream-2">
      <div className="mx-auto grid max-w-[1400px] items-center gap-14 px-6 py-0 lg:grid-cols-2 lg:px-10">
        <Reveal>
          ...
          <p className="mt-7 max-w-[46ch] text-carvao-soft">
            ...
            mais macio, mais seu, ano após ano. Cada peça EuroDesign é feita com
            couro selecionado, estrutura em madeira maciça e acabamento à mão.
          </p>
