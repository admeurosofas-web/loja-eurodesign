...
const PARCELAS: Record<string, number> = {
  ...
  "conjunto-turim": 18,                           // Conjunto Turim · 18x 439 (total 7.902)
  "sofa-milano-terracota": 12,                    // Milano · 12x 1.320 (total 15.840)
  "sofa-nice-02": 12,                             // Nice · 12x 899 (total 10.788)
  ...
  "sofa-agatha": 12,                              // Agatha · 12x 514 (total 6.168)
